...
from api import resize, run_prediction, find_max, display_image, file_upload
...
def run():
    ...
    maximum_index = find_max(run_prediction(resize(file_path)))
    display_image(resize(file_path)[maximum_index])
